                    ...
                    with open(caminho_arquivo, 'w') as f:
                        if item == 'main.cpp':
                            ...
                            f.write('Aditional flags:\n\n'
                                    ...
                                    '   Single file compilation (need to change for both Debug and Release) (in tasks.json):\n'
                                    '       "${file}" in place of: "*.cpp"\n'            
                                    '   Executable in the same source dir(need to change for both Debug and Release) (in tasks.json):\n'
                                    '       "${fileDirname}\\${fileBasenameNoExtension}.exe" in place of: "${workspaceFolder}/bin/(Debug or Release)/${workspaceFolderBasename}.exe"\n\n'
                                    '       Extra: to change executable name: {fileBasenameNoExtension}, {workspaceFolderBasename}\n'
                                    ...
                                    '       "-lsfml-window"\n'
                                    '       "-lsfml-system"\n\n'
                                    'Same flags are commented in original python file, so you can change previously if you need to.\n\n'
                                    'Make file:\n'
                                    '   You can change default configs such as flags, like with the ones above.\n'
